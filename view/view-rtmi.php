<?php
session_start();
if (!isset($_GET['rtmi_id'])) {
    die('<h1>Not possible</h1>');
}
include '../db.php';
$result = $conn->query('SELECT * FROM ready_to_move_in WHERE property_id=' . $_GET['rtmi_id'])->fetch_array();
$is_admin = false;
        ...
        $(document).ready(function() {
            $('.contact-agent-btn').click(function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        propId: '<?php echo $result["property_id"] ?>',
                        propType: 'ready-to-move-in'
                    },
                    dataType: "JSON",
                    success: function(response) {
                        if (response['success']) {
                            alert ('You have registered for a ready-to-move-in, You will receive an email from our agent/dealer regarding updates.')
                        } else {
    ...
    <div class="container" style="margin-top: 100px;">
        <div class="carousel-container">
            ...
            <div class="carousel-item active">
                <img src="../images/property-images/<?php echo $result['property_image_1'] ?>" alt="flat image 1" />
            </div>
            <div class="carousel-item">
                <img src="../images/property-images/<?php echo $result['property_image_2'] ?>" alt="flat image 2" />
            </div>
            <div class="carousel-item">
                <img src="../images/property-images/<?php echo $result['property_image_3'] ?>" alt="flat image 3" />
            </div>
            ...
            <table class="details">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $result['property_location'] ?></td>
                    </tr>
                    <tr>
                        <td>Property bhk:</td>
                        <td><?php echo $result['property_bhk'] ?></td>
                    </tr>
                    <tr>
                        <td>Square Feet:</td>
                        <td><?php echo $result['property_sqft'] ?> sqft</td>
                    </tr>
                    <tr>
                        <td>Floor Level:</td>
                        <td><?php echo $result['property_floor_level'] ?></td>
                    </tr>
                    <tr>
                        <td>Monthly Rent:</td>
                        <td><?php echo $result['property_monthly_rent'] ?> Rs.</td>
                    </tr>
                    <tr>
                        <td>Publicity Date:</td>
                        <td><?php echo $result['property_ad_date'] ?></td>
                    </tr>
                </tbody>
            </table>
